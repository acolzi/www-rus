...
<title><acx:lang>Regalami Un Sorriso ETS -Registrazione effettuata</acx:lang></title>
<!-- InstanceEndEditable -->
  ...
  <div class="row">
	...
	Complimenti <strong><%=utenteLogon.getCognomeNome()%></strong>, la registrazione   completata.</acx:if>
          ...
          <p>Salve, 
              ...
              Se la mail non  arrivata, contatta <a href="mailto:piero@pierogiacomelli.com">piero@pierogiacomelli.com</a> e verificheremo nel piu' breve tempo possibile.<br>
              <br>
              <font color="#FF0000">
              <%=msg%></font></span><br>
          </p>
          <p><br>
            *Grazie ai furbetti che hanno riempito il ns. database di email e codici fiscali fasulli, lasciandoci comunque gentilmente traccia dei loro indirizzo IP di accesso, siamo stati costretti ad attivare la verifica delle email tramite il codice di controllo. <br>
            Ciò non evita ovviamente che possiate continuare. <br>
