...
<!-- InstanceBeginEditable name="Bean" --><%@ taglib uri="/WEB-INF/news.tld" prefix="news" %>
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="main" -->
  <jsp:include page="_inc_header.jsp"  flush="true" >
  	<jsp:param name="menuAttivo" value="archivio"/>
  </jsp:include>
	<div class="container my-3">
  <iframe src="gallery1.php" style="width: 100%;min-height: 900px"></iframe>
</div>
