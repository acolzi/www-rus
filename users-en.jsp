...
<title>
<acx:lang>Regalami Un Sorriso ETS - Registrazione Utente</acx:lang>
</title>
<!-- InstanceEndEditable -->
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <acx:if wherecondition="<%=bean.isSocialAccount()%>">
                <div class="col-md-6 mb-3">
                  ...
                  <br>
                  <b style="color: darkred"> You are logged in using your <%=bean.getSocialIdType()%> account</b> </div>
              </acx:if>
              <acx:else>
            ...
            <div class="row">
              <div class="col-md-12 mb-4">
                ...
                <div class="invalid-feedback"> WARNING! Some fields have not been completed</div>
                <br>
                <div class="alert-warning" style="font-size: 24px; font-weight: BOLD;"> <%=msg%></div>
              </div>
            </div>
