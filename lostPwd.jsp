...
<title><acx:lang>Regalami Un Sorriso ETS -Recupero Password</acx:lang></title>
<!-- InstanceEndEditable -->
...
<div class="container my-3">
  <div class="row">
    <div class="col-lg-12 my-4">
      <h1 class="my-3"><acx:lang>Recupera Password</acx:lang></h1>
      <div class="row">
        <div class="col-lg-12 col-xs-12">
          <p align="left"> <acx:if wherecondition="<%=cartStatus.getStatus()==it.acxent.cart.CartStatus.ST_LOSTPWD_SEND_ERROR%>">
                    <font color="#800000"><b><acx:lang>ATTENZIONE!</acx:lang> <%=msg%><acx:lang>. Contattare</acx:lang> <a href="mailto:piero@pierogiacomelli.com"><acx:lang>piero@pierogiacomelli.com</acx:lang></a><a href="mailto:ordini@massimoravinaleshop.com">.</a>! </b></font></acx:if>
					<br>
                     <acx:if wherecondition="<%=cartStatus.getStatus()==it.acxent.cart.CartStatus.ST_LOSTPWD_SEND_OK %>"> <font color="#800000"><b><acx:lang>Il 
                    messaggio</acx:lang>  <acx:lang>stato spedito con successo!</acx:lang>
