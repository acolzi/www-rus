...
<div class="container my-3">
  <div class="row">
	...
	Congratulations <strong><%=utenteLogon.getCognomeNome()%></strong>, registration/modification completed. <br>
	If this is your first registration,
	an email has been sent to the specified address with a summary of the entered data and an activation link.
 </acx:if></p>
       <p><%=msg%></p>
        </div>
