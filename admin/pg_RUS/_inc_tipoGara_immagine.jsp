...
<jsp:useBean id="bean" class="it.acxent.pg.TipoGara" type="it.acxent.pg.TipoGara" scope="request" >
</jsp:useBean>
...
<div class="row">
  ...
  <acx:else>
    <acx:for begin="1" end="3" varname="i">
      <%int j=i.intValue();%>
      <!-- thumbnail -->
      <div class="col-lg-2 text-center loadImage" style="margin: 0; height: 220px;">
        ...
        <div id="img-area-div_${i}"  class="upload_foto"># ${i}
          <acx:if_img scaledWidth="100" scaledPrefix="100/"> <img src="../../_img/_tipoGara/<%=bean.getImgFileName(j) %>" id="imgNew_${i}" style="width:100px;"> 
            <script>
