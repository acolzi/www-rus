...
<!-- InstanceBeginEditable name="bean" --><jsp:useBean id="CR" class="it.acxent.pg.TipoGaraCR" type="it.acxent.pg.TipoGaraCR" scope="request" ></jsp:useBean><!-- InstanceEndEditable --><acx:if_logon_ok>
<div id="stRow"><!-- InstanceBeginEditable name="list" --> <acx:whilevec  rowbeanclass="it.acxent.pg.TipoGara"  vectumerator="list"> <%RI.setRiValues("");
RI.addRiValues(rowBean.getId_tipoGara());
RI.addRiValues(rowBean.getDescrizioneCompleta());
%><%=Ab.inputAjSearchDiv(list.getIndex(),RI.getSelectedKey(),RI.getDivList(),list.getIndex()+"-"+ rowBean.getDescrizioneCompleta())%>
