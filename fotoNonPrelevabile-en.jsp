...
<div class="container">
  <div class="row mb-5">
    <div class="col-lg-12">
      ...
      <p><strong><acx:lang></acx:lang>
      Attention! This photo cannot be downloaded! It will be available for download, as agreed with the organizer, only after the photography agency to which the exclusive rights have been granted has completed marketing.</strong></p>
    </div>
  </div>
