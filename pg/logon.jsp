...
<script language="JavaScript" src="_js/pg-logon.js"></script> 
...
</jsp:useBean><jsp:useBean id="msgS" class="java.lang.String" type="java.lang.String" scope="session" ></jsp:useBean>
...
<acx:else_logon>
Se sei un utente registrato inserisci il tuo login e la tua password. 
<br>Altrimenti registrati cliccando <a href="Registra.abl" style="font-weight: bold; font-size: 150%; color:#ED0C0C; text-decoration:underline;">qui
  </a>
<br>
<span style="font-weight: bold"><P>ATTENZIONE!!!!!<br> 
SE SIETE GIA' REGISTATI, MA NON RICORDATE LA PASSWORD NON EFFETTUATE UNA NUOVA REGISTRAZIONE<br><br>
PER RECUPERARE LA PASSWORD SCRIVETE A foto.atletica.immagine@gmail.com<br> O CHIAMATE IN ORARIO UFFICIO AL TEL 0574 876071<br><br>
SE NON SIETE ANCORA REGISTRATI FATELO CLICCANDO QUA ACCANTO ----->>  <a href="Registra.abl" style="color:#ED0C0C; text-decoration:underline;">NUOVA REGISTRAZIONE</a></span><br>
<table border="0" cellpadding="2" cellspacing="2" class="testoNormale" style="HEIGHT: 59px; WIDTH: 227px">
          ...
          <%=msgS %>     <% request.getSession().removeAttribute("msgS");%>     <!-- InstanceEndEditable -->
            </P>
          </DIV>
        </DIV>
        <!-- ------------------------------------------------------------------------ -->
