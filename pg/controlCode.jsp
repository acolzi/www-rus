...
<script language="JavaScript" src="_js/pg-users.js"></script> 
        ...
        <DIV id=bodyText>
          <DIV class=boxedLight align=left><!-- InstanceBeginEditable name="body" -->
            <p>Salve, 
              ...
              <br>
              questa &egrave; la prima volta che accedi al ns. sito*.<br>
              Nella mail che ti abbiamo inviato troverai un link che ti permetter&agrave; di attivare i tuoi dati di accesso immediatamente. <br>
              Se la mail non &egrave; arrivata, contatta<a href="mailto:piero@pierogiacomelli.com">piero@pierogiacomelli.com</a>e verificheremo nel piu' breve tempo possibile.<br>
              <br>
              <span style="font-weight: bold"><a href="javascript:history.back();">Torna Indietro</a></span><br>
              <font color="#FF0000"><br>
              <br>
              <%=msg%></font></span><br>
              <br>
*Grazie ai furbetti che hanno riempito il ns. database di email e codici fiscali fasulli, lasciandoci comunque gentilmente traccia dei loro indirizzo IP di accesso, siamo stati costretti ad attivare la verifica delle email tramite il codice di controllo. <br>
Ciò non evita ovviamente che possiate continuare. <br>
Dato che il sito non ha scopo di lucro, e anche se  cosi' non  fosse sarebbe esattamente lo stesso, sta al vostro buon senso comportarsi correttamente! <br>
Vorremmo evitare di attivare anche la gestione di black list di indirizzi IP.</p>
            <p>Grazie.</p>
            <p>&nbsp;</p>
          <!-- InstanceEndEditable -->
            </P>
