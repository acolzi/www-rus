...
<span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:9px; text-align:center;  ">Hits: <%=bean.getImpression()%> - <%=df.format(bean.getDataUltimaVisual())%> </span></acx:if>
</body>
</html>
