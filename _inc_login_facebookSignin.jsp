...
<input name="facebookName" type="hidden" id="facebookName">
<input name="facebookLast_name" type="hidden" id="facebookLast_name">
<input name="facebookEmail" type="hidden" id="facebookEmail">
<input name="facebookSignedRequest" type="hidden" id="facebookSignedRequest">
<!--inizio -->
...
function testfb()
  ...
  <!--
<a href="javascript:testfb()">TEST</a>
	<a href="javascript:logoutFb()">LOGOUTFB</a>--> 
</acx:if>
